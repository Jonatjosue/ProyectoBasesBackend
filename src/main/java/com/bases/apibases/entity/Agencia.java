...
public class Agencia implements Serializable {
    ...
    @Column(name ="AgenciaUsuarioModificación")
    private String AgenciaUsuarioModificación;

    @Column(name ="AgenciaFechaModificacion")
    private String AgenciaFechaModificacion;
